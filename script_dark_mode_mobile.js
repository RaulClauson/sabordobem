const mainContent2 = document.getElementById("main2")
const switchBTN2 = document.getElementById("switch2")


function clickEvent2() {
  if(mainContent2.classList.contains('main2--light')) {
    mainContent2.classList.remove('main2--light')
    mainContent2.classList.add('main2--dark')
  } else {
    mainContent2.classList.remove('main2--dark')
    mainContent2.classList.add('main2--light')
  }
}
...
var darkMode2 = document.getElementById('main2');
...
switchBTN2.addEventListener('click', clickEvent2)